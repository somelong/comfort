...
gulp.task("copyHarpImg",function () {
    return gulp.src("./src/images/Harp/*.{jpg,png}").pipe(gulp.dest("dist/images/Harp"));
});
gulp.task("copyUser_imgImg",function () {
    return gulp.src("./src/images/user_img/*.{jpg,png}").pipe(gulp.dest("dist/images/user_img"));
});
...
gulp.task("copyBootstrapCss",function () {
    return gulp.src("./src/bootstrap-3.3.7-dist/css/*.{css,map}").pipe(gulp.dest("dist/bootstrap-3.3.7-dist/css"));
});
...
/*=====================update=======================*/
gulp.task("copyUplods",function () {
    return gulp.src("./src/uploads/*.jpg").pipe(gulp.dest("dist/uploads"));
});
...
gulp.task("build",["copyHtml","copyAfterSalesHtml",
                   ...
                   "copyImg","copyActiveGoodsImg","copyActiveImgImg","copyAp1Img","copyAz1Img","copyCofalImg","copyColorImgImg","copyDingzhiImg","copyHarp_picImg","copyHuiyuanImg","copyIndexImg","copyLjImg","copyLoginImg","copyNavImg","copyPerson-memberImg","copyShowImgImg","copySofa_picImg","copyPhps_imgImg","copySp_imgImg","copyTm_imgImg","copyHarpImg","copyUser_imgImg",
...
gulp.task("allWatch",function () {
    gulp.watch(["./src/pages/*.html"],["reBuild"]);
});
